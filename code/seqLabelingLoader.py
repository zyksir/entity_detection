...
#####################################################################
# author of commentment:
# input file:
# QAData.valid.pkl, data/QAData.train.pkl, QAData.test.pkl
# 	format: a QAData class
# 
# output file: train.entity_detection.pt, test.entity_detection.pt, val.entity_detection.pt
# 	format: (seqs, seq_labels)
#	seqs: a list about words(we use index to represent the words)
#			each element is a Tensor of (len(tokens), batch_size)
#	seq_labels: a list about labels(0,1)
#			each element is a Tensor of (len(tokens), batch_size)
#####################################################################
